...
const Dummy = ({ children }: { children?: any }) => (
    <div className="bg-action-primary px-6 py-4 w-full h-full rounded text-dark text-sm">{children}</div>
);
const DummyLarge = ({ children }: { children?: any }) => (
    <div className="bg-action-primary px-6 py-6 w-full h-full rounded text-dark text-sm">{children}</div>
);
